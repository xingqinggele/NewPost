...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        if (null == mTextView) {
            ...
            mTextView.setBackgroundResource(R.mipmap.register_activity_code_btn1); //设置按钮为灰色，这时是不能点击的
            /**
             * 超链接 URLSpan
...
//            spannableString.setSpan(span, 0, 3, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);//将倒计时的时间设置为红色
            mTextView.setTextColor(Color.parseColor("#1673A3"));
    ...
    public void onFinish() {
        ...
        mTextView.setBackgroundResource(R.mipmap.register_activity_code_btn); //设置按钮为灰色，这时是不能点击的
