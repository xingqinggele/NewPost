package com.example.newpost.home_fragment.home_team;
...
import com.example.newpost.home_fragment.home_team.adapter.HomeTeamAdapter;
...
public class HomeTeamActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener, View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.hometeamactivity;
    }
    ...
    private void initList() {
        ...
        mAdapter = new HomeTeamAdapter(mData);
    ...
    public void postData(){
        ...
        HttpRequest.getPosUserList(params, SPUtils.get(HomeTeamActivity.this, "Token", "-1").toString(), new ResponseCallback() {
            @Override
