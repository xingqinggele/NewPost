...
import com.example.newpost.home_fragment.home_terminal.merchantstransfer.adapter.ManyRecyclerAdapter;
        ...
        RequestParams params = new RequestParams();
            ...
            HttpRequest.updPosListTo(params, SPUtils.get(MerchantsTransferActivity.this, "Token", "-1").toString(),beanList_size, new ResponseCallback() {
                ...
                public void onSuccess(Object responseObj) {
                    Intent intent = new Intent(MerchantsTransferActivity.this,MerchatsTransferSuccesActivity.class);
                    intent.putExtra("userName",userName);
                    intent.putExtra("machineNum",beanList_size.size()+"");
