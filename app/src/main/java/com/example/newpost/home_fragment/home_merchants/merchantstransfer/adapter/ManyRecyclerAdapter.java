package com.example.newpost.home_fragment.home_merchants.merchantstransfer.adapter;
...
public class ManyRecyclerAdapter extends RecyclerView.Adapter<ManyRecyclerViewHodler>{
    ...
    public ManyRecyclerAdapter(List<MermachineBean> list, Context context){
    ...
    public ManyRecyclerViewHodler onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.merchantstransfer_list_item,parent,false);
        return new ManyRecyclerViewHodler(view);
    }

    @Override
    public void onBindViewHolder(ManyRecyclerViewHodler holder, int position) {
        holder.textView_item_many_title_view.setText(list.get(position).getPosId().toString());
    ...
    public View.OnClickListener onclick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            ((MerchantsTransferActivity)context).setResponseState();
        }
    };
