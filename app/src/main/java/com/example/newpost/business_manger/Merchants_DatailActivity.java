...
public class Merchants_DatailActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        merchant_deteil_adress = findViewById(R.id.merchant_deteil_adress);
        iv_back.setOnClickListener(this);
        merchant_deteil_submint.setOnClickListener(this);
        merchant_deteil_type.setOnClickListener(this);
        merchant_deteil_adress.setOnClickListener(this);
        ...
        switch (view.getId()){
            ...
            case R.id.merchant_deteil_adress:
                ...
                if (isLoaded) {
                    ...
                    Toast.makeText(Merchants_DatailActivity.this, "Please waiting until the data is parsed", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
            ...
            switch (msg.what) {
                case MSG_LOAD_DATA:
                    if (thread == null) {//如果已创建就不再重新创建子线程了
                        ...
                        Toast.makeText(Merchants_DatailActivity.this, "Begin Parse Data", Toast.LENGTH_SHORT).show();
                ...
                case MSG_LOAD_SUCCESS:
                    Toast.makeText(Merchants_DatailActivity.this, "Parse Succeed", Toast.LENGTH_SHORT).show();
                    isLoaded = true;
                    break;

                case MSG_LOAD_FAILED:
                    Toast.makeText(Merchants_DatailActivity.this, "Parse Failed", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
...
//                Toast.makeText(Merchants_DatailActivity.this, tx, Toast.LENGTH_SHORT).show();
                merchant_deteil_adress.setText(tx);
            }
        })
                .setTitleText("城市选择")
